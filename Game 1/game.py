...
class Enemy(GameObject):
    def __init__(self, x, y):
        ...
        self.tag = 'enemy'
        color = (0.2, 1, 0.5, 1)
        # self.add_components(Sphere(1, color), Shootable(), SphereCollider(1, is_static=False))
        self.add_components(Cube(color, size=(2, 2, 2)), SphereCollider(1, is_static=False))
